...
public class Keys {
    ...
    private static class Identities0 {
		...
		public static Identity<JUserConfigRecord, Long> IDENTITY_USER_CONFIG = Internal.createIdentity(JUserConfig.USER_CONFIG,
				JUserConfig.USER_CONFIG.ID
		);
    ...
    private static class UniqueKeys0 {
		...
		public static final UniqueKey<JUserConfigRecord> USER_CONFIG_PK = Internal.createUniqueKey(JUserConfig.USER_CONFIG,
				"user_config_pk",
				JUserConfig.USER_CONFIG.ID
		);
    ...
    private static class ForeignKeys0 {
		...
		public static final ForeignKey<JUserConfigRecord, JUsersRecord> USER_CONFIG__USER_CONFIG_USER_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.USERS_PK,
				JUserConfig.USER_CONFIG,
				"user_config__user_config_user_id_fkey",
				JUserConfig.USER_CONFIG.USER_ID
		);
		public static final ForeignKey<JUserConfigRecord, JProjectRecord> USER_CONFIG__USER_CONFIG_PROJECT_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.PROJECT_PK,
				JUserConfig.USER_CONFIG,
				"user_config__user_config_project_id_fkey",
				JUserConfig.USER_CONFIG.PROJECT_ID
		);
