...
public class TestItem implements Serializable, BidirectionalTree, Interruptable {
	...
	public boolean equals(Object o) {
		...
		return hasChilds == testItem.hasChilds && Objects.equals(id, testItem.id) && Objects.equals(name, testItem.name)
				...
				&& Objects.equals(parameters, testItem.parameters) && Objects.equals(lastModified, testItem.lastModified) && Objects.equals(uniqueId,
				testItem.uniqueId
	...
	public static TestItem nullable() {
		TestItem item = new TestItem();
		item.setStatistics(null);
		item.setPath(null);
		return item;
	}
}
